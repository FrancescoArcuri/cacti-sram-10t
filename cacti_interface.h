...
enum SRAMcell_type // Alireza
{
    ...
    std_10T // standard 10T SRAM cell (Francesco)
};
...
class SRAMCellParameters // Alireza2
{
  private:
    ...
    double width, height;
    SRAMcell_type type; // standard 6T, or 8T SRAM cell - (Francesco) 10T as well
...
typedef struct{
  ...
  double delay_row_decoder; //Francesco: this variable can be removed because del row decoder delay has been splitted in reading and writing ones adding rwo_decoder_writing_delay and row_decoder_reading_delay
  double delay_bitlines; //Francesco: this variable can be removed because del bitline delay has been splitted in reading and writing ones adding writing_bitline_delay and reading_bitline_delay
...
class mem_array
{
  ...
  double delay_route_to_bank,
         ...
         row_decoder_writing_delay,  //Francesco: save the delay of decoder, demux (if any) and WL for 6T (or WWL for 8T and 10T)
         row_decoder_reading_delay,  //Francesco: save the delay of decoder, demux and RWL (for 8T and 10T)
         delay_bitlines,             //Francesco: save the reading delay of the bitline
         delay_sense_amp,
  ...
  powerDef power_dataout_vertical_htree;
  powerDef power_comparators;
  powerDef power_decoder;  //Francesco: save the value of the power of the decoder to do the assignment in ucache.cc
  powerDef power_wordline; //Francesco: save the value of the power of the wordline to do the assignment in ucache.cc
