...
class Decoder : public Component
{
  public:
    ...
    powerDef power;
    powerDef power_decoder; //Francesco: save the value of the power of the decoder
    powerDef power_wordline; //Francesco: save the value of the power of the WL (or WWL and RWL)
    bool   fully_assoc;
    bool   is_dram;
