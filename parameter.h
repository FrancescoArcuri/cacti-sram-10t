 ...
 public:
  ...
  class MemoryType
  {
   public:
    ...
    double cell_readacc_w; // Francesco: width of read access transistors for 10T cell: AL2 e AR2
    double cell_acc_w;     // Francesco: width of access transistors for 10T cell: AL1 e AR1
    double cell_a_w;      // Alireza: width of (write) access transistors for 6T and 8T cells
    double cell_pmos_w;   // Alireza: width of pull-up (pmos) transistors for 6T and 8T cells - (Francesco) 10T as well
    double cell_nmos_w;   // Alireza: width of pull-down (nmos) transistors for 6T and 8T cells - (Francesco) 10T as well
    ...
    double cell_iso_w;    // Francesco: width of the isolator transistor for 10T cell -> NL e NR
  ...
  double w_sense_n;
  double w_sense_p;
  //Fabio start -- defining the sizing of the skewed inverter for 8T sensing
